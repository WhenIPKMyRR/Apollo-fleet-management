...
//             carToUpdate.Color = this.txtColor.Text;
//             carToUpdate.LicensePlate = this.txtLicensePlate.Text;
//             carToUpdate.BodyworkType = this.txtBodyworkType.Text;
//             carToUpdate.Price = Convert.ToDecimal(this.txtPrice.Text);
//             carToUpdate.ChassisCode = this.txtChassisCode.Text;
//             carToUpdate.RenavanCode = this.txtRenavanCode.Text;
//             carToUpdate.FuelType = this.txtFuelType.Text;
//             carToUpdate.TransmissionType = this.txtCarTransmissionType.Text;
//             carToUpdate.CarMileage = Convert.ToInt32(this.txtCarMileage.Text);
//             carToUpdate.ModelId = Convert.ToInt32(this.txtIdModel.Text);
//             carToUpdate.BrandId = Convert.ToInt32(this.txtIdBrand.Text);
