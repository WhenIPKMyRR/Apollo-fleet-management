...
//         {
//             Models.Document documentToUpdate = this.Document;
//             documentToUpdate.Type = this.txtType.Text;
//             documentToUpdate.Value = this.txtValue.Text;
//             documentToUpdate.IdCar = this.txtIdCar.Text;
